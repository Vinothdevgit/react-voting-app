    ...
    <div style={styles.sidebar}>
      ...
      <nav>
        <ul style={styles.navList}>
          ...
          {/* Link to the Add Candidate page for admin users */}
          <li><Link style={styles.link} to="/admin/add-candidate">🆕 Add Candidate</Link></li>
          <li><Link style={styles.link} to="/admin/view-votes">📊 View Votes</Link></li>
          <li><Link style={styles.link} to="/admin/candidates">🆕 View Candidates</Link></li>
        </ul>
      </nav>
    </div>
  );
